...
public class ApiClient {
    ...
    private String basePath = "https://thracesystems.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2021.4.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://thracesystems.com/api
