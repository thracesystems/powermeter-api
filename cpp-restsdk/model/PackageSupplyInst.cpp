...
PackageSupplyInst::PackageSupplyInst()
{
    m_Id = 0;
    m_IdIsSet = false;
    m_Container = 0;
...
void PackageSupplyInst::validate()
{
    // TODO: implement validation
}

web::json::value PackageSupplyInst::toJson() const
{
...
bool PackageSupplyInst::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PackageSupplyInst::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PackageSupplyInst::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t PackageSupplyInst::getId() const
{
    return m_Id;
}

void PackageSupplyInst::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool PackageSupplyInst::idIsSet() const
{
    return m_IdIsSet;
}

void PackageSupplyInst::unsetId()
{
    m_IdIsSet = false;
}
int32_t PackageSupplyInst::getContainer() const
{
    return m_Container;
}

void PackageSupplyInst::setContainer(int32_t value)
{
    m_Container = value;
    m_ContainerIsSet = true;
}

bool PackageSupplyInst::containerIsSet() const
{
    return m_ContainerIsSet;
}

void PackageSupplyInst::unsetContainer()
{
    m_ContainerIsSet = false;
}
int32_t PackageSupplyInst::getMaster() const
{
    return m_Master;
}

void PackageSupplyInst::setMaster(int32_t value)
{
    m_Master = value;
    m_MasterIsSet = true;
}

bool PackageSupplyInst::masterIsSet() const
{
    return m_MasterIsSet;
}

void PackageSupplyInst::unsetMaster()
{
    m_MasterIsSet = false;
}
utility::string_t PackageSupplyInst::getColor() const
{
    return m_Color;
}

void PackageSupplyInst::setColor(const utility::string_t& value)
{
    m_Color = value;
    m_ColorIsSet = true;
}

bool PackageSupplyInst::colorIsSet() const
{
    return m_ColorIsSet;
}

void PackageSupplyInst::unsetColor()
{
    m_ColorIsSet = false;
}
utility::string_t PackageSupplyInst::getConnectionColor() const
{
    return m_Connection_color;
}

void PackageSupplyInst::setConnectionColor(const utility::string_t& value)
{
    m_Connection_color = value;
    m_Connection_colorIsSet = true;
}

bool PackageSupplyInst::connectionColorIsSet() const
{
    return m_Connection_colorIsSet;
}

void PackageSupplyInst::unsetConnection_color()
{
    m_Connection_colorIsSet = false;
}
utility::string_t PackageSupplyInst::getMasterName() const
{
    return m_Master_name;
}

void PackageSupplyInst::setMasterName(const utility::string_t& value)
{
    m_Master_name = value;
    m_Master_nameIsSet = true;
}

bool PackageSupplyInst::masterNameIsSet() const
{
    return m_Master_nameIsSet;
}

void PackageSupplyInst::unsetMaster_name()
{
    m_Master_nameIsSet = false;
}
utility::string_t PackageSupplyInst::getHierName() const
{
    return m_Hier_name;
}

void PackageSupplyInst::setHierName(const utility::string_t& value)
{
    m_Hier_name = value;
    m_Hier_nameIsSet = true;
}

bool PackageSupplyInst::hierNameIsSet() const
{
    return m_Hier_nameIsSet;
}

void PackageSupplyInst::unsetHier_name()
{
    m_Hier_nameIsSet = false;
}
int32_t PackageSupplyInst::getConnectedTo() const
{
    return m_Connected_to;
}

void PackageSupplyInst::setConnectedTo(int32_t value)
{
    m_Connected_to = value;
    m_Connected_toIsSet = true;
}

bool PackageSupplyInst::connectedToIsSet() const
{
    return m_Connected_toIsSet;
}

void PackageSupplyInst::unsetConnected_to()
{
    m_Connected_toIsSet = false;
}
utility::string_t PackageSupplyInst::getConnectedToType() const
{
    return m_Connected_to_type;
}

void PackageSupplyInst::setConnectedToType(const utility::string_t& value)
{
    m_Connected_to_type = value;
    m_Connected_to_typeIsSet = true;
}

bool PackageSupplyInst::connectedToTypeIsSet() const
{
    return m_Connected_to_typeIsSet;
}

void PackageSupplyInst::unsetConnected_to_type()
{
    m_Connected_to_typeIsSet = false;
}
}
