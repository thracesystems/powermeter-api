...
void ProjectAccess::validate()
{
    // TODO: implement validation
}

web::json::value ProjectAccess::toJson() const
{
...
bool ProjectAccess::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ProjectAccess::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectAccess::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t ProjectAccess::getProject() const
{
    return m_Project;
}

void ProjectAccess::setProject(int32_t value)
{
    m_Project = value;
    m_ProjectIsSet = true;
}

bool ProjectAccess::projectIsSet() const
{
    return m_ProjectIsSet;
}

void ProjectAccess::unsetProject()
{
    m_ProjectIsSet = false;
}
utility::string_t ProjectAccess::getProjectName() const
{
    return m_Project_name;
}

void ProjectAccess::setProjectName(const utility::string_t& value)
{
    m_Project_name = value;
    m_Project_nameIsSet = true;
}

bool ProjectAccess::projectNameIsSet() const
{
    return m_Project_nameIsSet;
}

void ProjectAccess::unsetProject_name()
{
    m_Project_nameIsSet = false;
}
utility::datetime ProjectAccess::getTimestamp() const
{
    return m_Timestamp;
}

void ProjectAccess::setTimestamp(const utility::datetime& value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ProjectAccess::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ProjectAccess::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
}
