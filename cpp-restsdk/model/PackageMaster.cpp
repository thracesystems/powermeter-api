...
void PackageMaster::validate()
{
    // TODO: implement validation
}

web::json::value PackageMaster::toJson() const
{
...
bool PackageMaster::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PackageMaster::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PackageMaster::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t PackageMaster::getId() const
{
    return m_Id;
}

void PackageMaster::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool PackageMaster::idIsSet() const
{
    return m_IdIsSet;
}

void PackageMaster::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t PackageMaster::getName() const
{
    return m_Name;
}

void PackageMaster::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool PackageMaster::nameIsSet() const
{
    return m_NameIsSet;
}

void PackageMaster::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t PackageMaster::getDescr() const
{
    return m_Descr;
}

void PackageMaster::setDescr(const utility::string_t& value)
{
    m_Descr = value;
    m_DescrIsSet = true;
}

bool PackageMaster::descrIsSet() const
{
    return m_DescrIsSet;
}

void PackageMaster::unsetDescr()
{
    m_DescrIsSet = false;
}
int32_t PackageMaster::getLatestCommit() const
{
    return m_Latest_commit;
}

void PackageMaster::setLatestCommit(int32_t value)
{
    m_Latest_commit = value;
    m_Latest_commitIsSet = true;
}

bool PackageMaster::latestCommitIsSet() const
{
    return m_Latest_commitIsSet;
}

void PackageMaster::unsetLatest_commit()
{
    m_Latest_commitIsSet = false;
}
int32_t PackageMaster::getCurrentVersion() const
{
    return m_Current_version;
}

void PackageMaster::setCurrentVersion(int32_t value)
{
    m_Current_version = value;
    m_Current_versionIsSet = true;
}

bool PackageMaster::currentVersionIsSet() const
{
    return m_Current_versionIsSet;
}

void PackageMaster::unsetCurrent_version()
{
    m_Current_versionIsSet = false;
}
int32_t PackageMaster::getLatestCommitVersion() const
{
    return m_Latest_commit_version;
}

void PackageMaster::setLatestCommitVersion(int32_t value)
{
    m_Latest_commit_version = value;
    m_Latest_commit_versionIsSet = true;
}

bool PackageMaster::latestCommitVersionIsSet() const
{
    return m_Latest_commit_versionIsSet;
}

void PackageMaster::unsetLatest_commit_version()
{
    m_Latest_commit_versionIsSet = false;
}
utility::string_t PackageMaster::getLatestCommitTimestamp() const
{
    return m_Latest_commit_timestamp;
}

void PackageMaster::setLatestCommitTimestamp(const utility::string_t& value)
{
    m_Latest_commit_timestamp = value;
    m_Latest_commit_timestampIsSet = true;
}

bool PackageMaster::latestCommitTimestampIsSet() const
{
    return m_Latest_commit_timestampIsSet;
}

void PackageMaster::unsetLatest_commit_timestamp()
{
    m_Latest_commit_timestampIsSet = false;
}
}
