...
#ifndef POWERMETER_MODEL_DesignFF_H_
#define POWERMETER_MODEL_DesignFF_H_
...
public:
    ...
    /// 
    /// </summary>
    utility::string_t getClockedOn() const;
    bool clockedOnIsSet() const;
    void unsetClocked_on();

    void setClockedOn(const utility::string_t& value);

    /// <summary>
    /// 
    /// </summary>
    utility::string_t getClockedOnAlso() const;
    bool clockedOnAlsoIsSet() const;
    void unsetClocked_on_also();

    void setClockedOnAlso(const utility::string_t& value);

    /// <summary>
    /// 
    /// </summary>
    utility::string_t getNextState() const;
    bool nextStateIsSet() const;
    void unsetNext_state();

    void setNextState(const utility::string_t& value);
...
protected:
    ...
    int32_t m_Bits;
    bool m_BitsIsSet;
    utility::string_t m_Clocked_on;
    bool m_Clocked_onIsSet;
    utility::string_t m_Clocked_on_also;
    bool m_Clocked_on_alsoIsSet;
    utility::string_t m_Next_state;
    bool m_Next_stateIsSet;
...
#endif /* POWERMETER_MODEL_DesignFF_H_ */
