...
DesignPinEnergy::DesignPinEnergy()
{
    m_Id = 0;
    m_IdIsSet = false;
    m_Pin = 0;
...
void DesignPinEnergy::validate()
{
    // TODO: implement validation
}

web::json::value DesignPinEnergy::toJson() const
{
...
bool DesignPinEnergy::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DesignPinEnergy::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DesignPinEnergy::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t DesignPinEnergy::getId() const
{
    return m_Id;
}

void DesignPinEnergy::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DesignPinEnergy::idIsSet() const
{
    return m_IdIsSet;
}

void DesignPinEnergy::unsetId()
{
    m_IdIsSet = false;
}
int32_t DesignPinEnergy::getPin() const
{
    return m_Pin;
}

void DesignPinEnergy::setPin(int32_t value)
{
    m_Pin = value;
    m_PinIsSet = true;
}

bool DesignPinEnergy::pinIsSet() const
{
    return m_PinIsSet;
}

void DesignPinEnergy::unsetPin()
{
    m_PinIsSet = false;
}
utility::string_t DesignPinEnergy::getPinName() const
{
    return m_Pin_name;
}

void DesignPinEnergy::setPinName(const utility::string_t& value)
{
    m_Pin_name = value;
    m_Pin_nameIsSet = true;
}

bool DesignPinEnergy::pinNameIsSet() const
{
    return m_Pin_nameIsSet;
}

void DesignPinEnergy::unsetPin_name()
{
    m_Pin_nameIsSet = false;
}
int32_t DesignPinEnergy::getRelatedPin() const
{
    return m_Related_pin;
}

void DesignPinEnergy::setRelatedPin(int32_t value)
{
    m_Related_pin = value;
    m_Related_pinIsSet = true;
}

bool DesignPinEnergy::relatedPinIsSet() const
{
    return m_Related_pinIsSet;
}

void DesignPinEnergy::unsetRelated_pin()
{
    m_Related_pinIsSet = false;
}
utility::string_t DesignPinEnergy::getRelatedPinName() const
{
    return m_Related_pin_name;
}

void DesignPinEnergy::setRelatedPinName(const utility::string_t& value)
{
    m_Related_pin_name = value;
    m_Related_pin_nameIsSet = true;
}

bool DesignPinEnergy::relatedPinNameIsSet() const
{
    return m_Related_pin_nameIsSet;
}

void DesignPinEnergy::unsetRelated_pin_name()
{
    m_Related_pin_nameIsSet = false;
}
int32_t DesignPinEnergy::getSupply() const
{
    return m_Supply;
}

void DesignPinEnergy::setSupply(int32_t value)
{
    m_Supply = value;
    m_SupplyIsSet = true;
}

bool DesignPinEnergy::supplyIsSet() const
{
    return m_SupplyIsSet;
}

void DesignPinEnergy::unsetSupply()
{
    m_SupplyIsSet = false;
}
utility::string_t DesignPinEnergy::getSupplyName() const
{
    return m_Supply_name;
}

void DesignPinEnergy::setSupplyName(const utility::string_t& value)
{
    m_Supply_name = value;
    m_Supply_nameIsSet = true;
}

bool DesignPinEnergy::supplyNameIsSet() const
{
    return m_Supply_nameIsSet;
}

void DesignPinEnergy::unsetSupply_name()
{
    m_Supply_nameIsSet = false;
}
utility::string_t DesignPinEnergy::getProcess() const
{
    return m_Process;
}

void DesignPinEnergy::setProcess(const utility::string_t& value)
{
    m_Process = value;
    m_ProcessIsSet = true;
}

bool DesignPinEnergy::processIsSet() const
{
    return m_ProcessIsSet;
}

void DesignPinEnergy::unsetProcess()
{
    m_ProcessIsSet = false;
}
utility::string_t DesignPinEnergy::getRc() const
{
    return m_Rc;
}

void DesignPinEnergy::setRc(const utility::string_t& value)
{
    m_Rc = value;
    m_RcIsSet = true;
}

bool DesignPinEnergy::rcIsSet() const
{
    return m_RcIsSet;
}

void DesignPinEnergy::unsetRc()
{
    m_RcIsSet = false;
}
double DesignPinEnergy::getVoltage() const
{
    return m_Voltage;
}

void DesignPinEnergy::setVoltage(double value)
{
    m_Voltage = value;
    m_VoltageIsSet = true;
}

bool DesignPinEnergy::voltageIsSet() const
{
    return m_VoltageIsSet;
}

void DesignPinEnergy::unsetVoltage()
{
    m_VoltageIsSet = false;
}
int32_t DesignPinEnergy::getTemperature() const
{
    return m_Temperature;
}

void DesignPinEnergy::setTemperature(int32_t value)
{
    m_Temperature = value;
    m_TemperatureIsSet = true;
}

bool DesignPinEnergy::temperatureIsSet() const
{
    return m_TemperatureIsSet;
}

void DesignPinEnergy::unsetTemperature()
{
    m_TemperatureIsSet = false;
}
utility::string_t DesignPinEnergy::getWhen() const
{
    return m_When;
}

void DesignPinEnergy::setWhen(const utility::string_t& value)
{
    m_When = value;
    m_WhenIsSet = true;
}

bool DesignPinEnergy::whenIsSet() const
{
    return m_WhenIsSet;
}

void DesignPinEnergy::unsetWhen()
{
    m_WhenIsSet = false;
}
std::vector<double>& DesignPinEnergy::getIndex1()
{
    return m_Index1;
}

void DesignPinEnergy::setIndex1(std::vector<double> value)
{
    m_Index1 = value;
    m_Index1IsSet = true;
}

bool DesignPinEnergy::index1IsSet() const
{
    return m_Index1IsSet;
}

void DesignPinEnergy::unsetIndex1()
{
    m_Index1IsSet = false;
}
utility::string_t DesignPinEnergy::getVariable1() const
{
    return m_Variable1;
}

void DesignPinEnergy::setVariable1(const utility::string_t& value)
{
    m_Variable1 = value;
    m_Variable1IsSet = true;
}

bool DesignPinEnergy::variable1IsSet() const
{
    return m_Variable1IsSet;
}

void DesignPinEnergy::unsetVariable1()
{
    m_Variable1IsSet = false;
}
std::vector<double>& DesignPinEnergy::getIndex2()
{
    return m_Index2;
}

void DesignPinEnergy::setIndex2(std::vector<double> value)
{
    m_Index2 = value;
    m_Index2IsSet = true;
}

bool DesignPinEnergy::index2IsSet() const
{
    return m_Index2IsSet;
}

void DesignPinEnergy::unsetIndex2()
{
    m_Index2IsSet = false;
}
utility::string_t DesignPinEnergy::getVariable2() const
{
    return m_Variable2;
}

void DesignPinEnergy::setVariable2(const utility::string_t& value)
{
    m_Variable2 = value;
    m_Variable2IsSet = true;
}

bool DesignPinEnergy::variable2IsSet() const
{
    return m_Variable2IsSet;
}

void DesignPinEnergy::unsetVariable2()
{
    m_Variable2IsSet = false;
}
std::vector<double>& DesignPinEnergy::getRiseEnergy()
{
    return m_Rise_energy;
}

void DesignPinEnergy::setRiseEnergy(std::vector<double> value)
{
    m_Rise_energy = value;
    m_Rise_energyIsSet = true;
}

bool DesignPinEnergy::riseEnergyIsSet() const
{
    return m_Rise_energyIsSet;
}

void DesignPinEnergy::unsetRise_energy()
{
    m_Rise_energyIsSet = false;
}
std::vector<double>& DesignPinEnergy::getFallEnergy()
{
    return m_Fall_energy;
}

void DesignPinEnergy::setFallEnergy(std::vector<double> value)
{
    m_Fall_energy = value;
    m_Fall_energyIsSet = true;
}

bool DesignPinEnergy::fallEnergyIsSet() const
{
    return m_Fall_energyIsSet;
}

void DesignPinEnergy::unsetFall_energy()
{
    m_Fall_energyIsSet = false;
}
std::vector<int32_t>& DesignPinEnergy::getModes()
{
    return m_Modes;
}

void DesignPinEnergy::setModes(std::vector<int32_t> value)
{
    m_Modes = value;
    m_ModesIsSet = true;
}

bool DesignPinEnergy::modesIsSet() const
{
    return m_ModesIsSet;
}

void DesignPinEnergy::unsetModes()
{
    m_ModesIsSet = false;
}
}
