...
void VRMaster::validate()
{
    // TODO: implement validation
}

web::json::value VRMaster::toJson() const
{
...
bool VRMaster::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VRMaster::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VRMaster::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t VRMaster::getId() const
{
    return m_Id;
}

void VRMaster::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool VRMaster::idIsSet() const
{
    return m_IdIsSet;
}

void VRMaster::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t VRMaster::getName() const
{
    return m_Name;
}

void VRMaster::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool VRMaster::nameIsSet() const
{
    return m_NameIsSet;
}

void VRMaster::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t VRMaster::getDescr() const
{
    return m_Descr;
}

void VRMaster::setDescr(const utility::string_t& value)
{
    m_Descr = value;
    m_DescrIsSet = true;
}

bool VRMaster::descrIsSet() const
{
    return m_DescrIsSet;
}

void VRMaster::unsetDescr()
{
    m_DescrIsSet = false;
}
int32_t VRMaster::getLatestCommit() const
{
    return m_Latest_commit;
}

void VRMaster::setLatestCommit(int32_t value)
{
    m_Latest_commit = value;
    m_Latest_commitIsSet = true;
}

bool VRMaster::latestCommitIsSet() const
{
    return m_Latest_commitIsSet;
}

void VRMaster::unsetLatest_commit()
{
    m_Latest_commitIsSet = false;
}
int32_t VRMaster::getCurrentVersion() const
{
    return m_Current_version;
}

void VRMaster::setCurrentVersion(int32_t value)
{
    m_Current_version = value;
    m_Current_versionIsSet = true;
}

bool VRMaster::currentVersionIsSet() const
{
    return m_Current_versionIsSet;
}

void VRMaster::unsetCurrent_version()
{
    m_Current_versionIsSet = false;
}
int32_t VRMaster::getLatestCommitVersion() const
{
    return m_Latest_commit_version;
}

void VRMaster::setLatestCommitVersion(int32_t value)
{
    m_Latest_commit_version = value;
    m_Latest_commit_versionIsSet = true;
}

bool VRMaster::latestCommitVersionIsSet() const
{
    return m_Latest_commit_versionIsSet;
}

void VRMaster::unsetLatest_commit_version()
{
    m_Latest_commit_versionIsSet = false;
}
utility::string_t VRMaster::getLatestCommitTimestamp() const
{
    return m_Latest_commit_timestamp;
}

void VRMaster::setLatestCommitTimestamp(const utility::string_t& value)
{
    m_Latest_commit_timestamp = value;
    m_Latest_commit_timestampIsSet = true;
}

bool VRMaster::latestCommitTimestampIsSet() const
{
    return m_Latest_commit_timestampIsSet;
}

void VRMaster::unsetLatest_commit_timestamp()
{
    m_Latest_commit_timestampIsSet = false;
}
}
