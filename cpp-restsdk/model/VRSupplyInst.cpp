...
void VRSupplyInst::validate()
{
    // TODO: implement validation
}

web::json::value VRSupplyInst::toJson() const
{
...
bool VRSupplyInst::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void VRSupplyInst::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool VRSupplyInst::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
...
int32_t VRSupplyInst::getId() const
{
    return m_Id;
}

void VRSupplyInst::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool VRSupplyInst::idIsSet() const
{
    return m_IdIsSet;
}

void VRSupplyInst::unsetId()
{
    m_IdIsSet = false;
}
int32_t VRSupplyInst::getContainer() const
{
    return m_Container;
}

void VRSupplyInst::setContainer(int32_t value)
{
    m_Container = value;
    m_ContainerIsSet = true;
}

bool VRSupplyInst::containerIsSet() const
{
    return m_ContainerIsSet;
}

void VRSupplyInst::unsetContainer()
{
    m_ContainerIsSet = false;
}
int32_t VRSupplyInst::getMaster() const
{
    return m_Master;
}

void VRSupplyInst::setMaster(int32_t value)
{
    m_Master = value;
    m_MasterIsSet = true;
}

bool VRSupplyInst::masterIsSet() const
{
    return m_MasterIsSet;
}

void VRSupplyInst::unsetMaster()
{
    m_MasterIsSet = false;
}
utility::string_t VRSupplyInst::getColor() const
{
    return m_Color;
}

void VRSupplyInst::setColor(const utility::string_t& value)
{
    m_Color = value;
    m_ColorIsSet = true;
}

bool VRSupplyInst::colorIsSet() const
{
    return m_ColorIsSet;
}

void VRSupplyInst::unsetColor()
{
    m_ColorIsSet = false;
}
utility::string_t VRSupplyInst::getConnectionColor() const
{
    return m_Connection_color;
}

void VRSupplyInst::setConnectionColor(const utility::string_t& value)
{
    m_Connection_color = value;
    m_Connection_colorIsSet = true;
}

bool VRSupplyInst::connectionColorIsSet() const
{
    return m_Connection_colorIsSet;
}

void VRSupplyInst::unsetConnection_color()
{
    m_Connection_colorIsSet = false;
}
utility::string_t VRSupplyInst::getMasterName() const
{
    return m_Master_name;
}

void VRSupplyInst::setMasterName(const utility::string_t& value)
{
    m_Master_name = value;
    m_Master_nameIsSet = true;
}

bool VRSupplyInst::masterNameIsSet() const
{
    return m_Master_nameIsSet;
}

void VRSupplyInst::unsetMaster_name()
{
    m_Master_nameIsSet = false;
}
utility::string_t VRSupplyInst::getHierName() const
{
    return m_Hier_name;
}

void VRSupplyInst::setHierName(const utility::string_t& value)
{
    m_Hier_name = value;
    m_Hier_nameIsSet = true;
}

bool VRSupplyInst::hierNameIsSet() const
{
    return m_Hier_nameIsSet;
}

void VRSupplyInst::unsetHier_name()
{
    m_Hier_nameIsSet = false;
}
int32_t VRSupplyInst::getConnectedTo() const
{
    return m_Connected_to;
}

void VRSupplyInst::setConnectedTo(int32_t value)
{
    m_Connected_to = value;
    m_Connected_toIsSet = true;
}

bool VRSupplyInst::connectedToIsSet() const
{
    return m_Connected_toIsSet;
}

void VRSupplyInst::unsetConnected_to()
{
    m_Connected_toIsSet = false;
}
utility::string_t VRSupplyInst::getConnectedToType() const
{
    return m_Connected_to_type;
}

void VRSupplyInst::setConnectedToType(const utility::string_t& value)
{
    m_Connected_to_type = value;
    m_Connected_to_typeIsSet = true;
}

bool VRSupplyInst::connectedToTypeIsSet() const
{
    return m_Connected_to_typeIsSet;
}

void VRSupplyInst::unsetConnected_to_type()
{
    m_Connected_to_typeIsSet = false;
}
utility::string_t VRSupplyInst::getDirection() const
{
    return m_Direction;
}

void VRSupplyInst::setDirection(const utility::string_t& value)
{
    m_Direction = value;
    m_DirectionIsSet = true;
}

bool VRSupplyInst::directionIsSet() const
{
    return m_DirectionIsSet;
}

void VRSupplyInst::unsetDirection()
{
    m_DirectionIsSet = false;
}
}
