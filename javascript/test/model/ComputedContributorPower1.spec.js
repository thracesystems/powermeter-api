...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.ComputedContributorPower1();
  });
  ...
  describe('ComputedContributorPower1', function() {
    it('should create an instance of ComputedContributorPower1', function() {
      // uncomment below and update the code to test ComputedContributorPower1
      //var instane = new PowermeterApi.ComputedContributorPower1();
      //expect(instance).to.be.a(PowermeterApi.ComputedContributorPower1);
    });
