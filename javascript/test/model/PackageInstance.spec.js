...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PackageInstance();
  });
  ...
  describe('PackageInstance', function() {
    it('should create an instance of PackageInstance', function() {
      // uncomment below and update the code to test PackageInstance
      //var instane = new PowermeterApi.PackageInstance();
      //expect(instance).to.be.a(PowermeterApi.PackageInstance);
    });
    ...
    it('should have the property heatsink (base name: "heatsink")', function() {
      // uncomment below and update the code to test the property heatsink
      //var instane = new PowermeterApi.PackageInstance();
      //expect(instance).to.be();
    });

    it('should have the property heatsinkMaster (base name: "heatsink_master")', function() {
      // uncomment below and update the code to test the property heatsinkMaster
      //var instane = new PowermeterApi.PackageInstance();
      //expect(instance).to.be();
    });

    it('should have the property heatsinkName (base name: "heatsink_name")', function() {
      // uncomment below and update the code to test the property heatsinkName
      //var instane = new PowermeterApi.PackageInstance();
      //expect(instance).to.be();
    });
