...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PCBSupplyInst();
  });
  ...
  describe('PCBSupplyInst', function() {
    it('should create an instance of PCBSupplyInst', function() {
      // uncomment below and update the code to test PCBSupplyInst
      //var instane = new PowermeterApi.PCBSupplyInst();
      //expect(instance).to.be.a(PowermeterApi.PCBSupplyInst);
    });
