...
(function(root, factory) {
  ...
  describe('VR', function() {
    it('should create an instance of VR', function() {
      // uncomment below and update the code to test VR
      //var instane = new PowermeterApi.VR();
      //expect(instance).to.be.a(PowermeterApi.VR);
    });
    ...
    it('should have the property linearIq (base name: "linear_iq")', function() {
      // uncomment below and update the code to test the property linearIq
      //var instane = new PowermeterApi.VR();
      //expect(instance).to.be();
    });

    it('should have the property switchedEfficiency (base name: "switched_efficiency")', function() {
      // uncomment below and update the code to test the property switchedEfficiency
      //var instane = new PowermeterApi.VR();
      //expect(instance).to.be();
    });
