...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.WLMModel();
  });
  ...
  describe('WLMModel', function() {
    it('should create an instance of WLMModel', function() {
      // uncomment below and update the code to test WLMModel
      //var instane = new PowermeterApi.WLMModel();
      //expect(instance).to.be.a(PowermeterApi.WLMModel);
    });
    ...
    it('should have the property wireloads (base name: "wireloads")', function() {
      // uncomment below and update the code to test the property wireloads
      //var instane = new PowermeterApi.WLMModel();
      //expect(instance).to.be();
    });
