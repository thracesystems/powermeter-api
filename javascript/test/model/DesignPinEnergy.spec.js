...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.DesignPinEnergy();
  });
  ...
  describe('DesignPinEnergy', function() {
    it('should create an instance of DesignPinEnergy', function() {
      // uncomment below and update the code to test DesignPinEnergy
      //var instane = new PowermeterApi.DesignPinEnergy();
      //expect(instance).to.be.a(PowermeterApi.DesignPinEnergy);
    });
