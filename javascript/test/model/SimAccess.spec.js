...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.SimAccess();
  });
  ...
  describe('SimAccess', function() {
    it('should create an instance of SimAccess', function() {
      // uncomment below and update the code to test SimAccess
      //var instane = new PowermeterApi.SimAccess();
      //expect(instance).to.be.a(PowermeterApi.SimAccess);
    });
