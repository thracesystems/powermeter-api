...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.UpdateData();
  });
  ...
  describe('UpdateData', function() {
    it('should create an instance of UpdateData', function() {
      // uncomment below and update the code to test UpdateData
      //var instane = new PowermeterApi.UpdateData();
      //expect(instance).to.be.a(PowermeterApi.UpdateData);
    });
