...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.VRInstance();
  });
  ...
  describe('VRInstance', function() {
    it('should create an instance of VRInstance', function() {
      // uncomment below and update the code to test VRInstance
      //var instane = new PowermeterApi.VRInstance();
      //expect(instance).to.be.a(PowermeterApi.VRInstance);
    });
