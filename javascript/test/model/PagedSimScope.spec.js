...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PagedSimScope();
  });
  ...
  describe('PagedSimScope', function() {
    it('should create an instance of PagedSimScope', function() {
      // uncomment below and update the code to test PagedSimScope
      //var instane = new PowermeterApi.PagedSimScope();
      //expect(instance).to.be.a(PowermeterApi.PagedSimScope);
    });
