...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PagedLeakagePower();
  });
  ...
  describe('PagedLeakagePower', function() {
    it('should create an instance of PagedLeakagePower', function() {
      // uncomment below and update the code to test PagedLeakagePower
      //var instane = new PowermeterApi.PagedLeakagePower();
      //expect(instance).to.be.a(PowermeterApi.PagedLeakagePower);
    });
