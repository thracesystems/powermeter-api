...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PCBInstance();
  });
  ...
  describe('PCBInstance', function() {
    it('should create an instance of PCBInstance', function() {
      // uncomment below and update the code to test PCBInstance
      //var instane = new PowermeterApi.PCBInstance();
      //expect(instance).to.be.a(PowermeterApi.PCBInstance);
    });
