...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.DesignVersion();
  });
  ...
  describe('DesignVersion', function() {
    it('should create an instance of DesignVersion', function() {
      // uncomment below and update the code to test DesignVersion
      //var instane = new PowermeterApi.DesignVersion();
      //expect(instance).to.be.a(PowermeterApi.DesignVersion);
    });
