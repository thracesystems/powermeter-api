...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.LeakagePower();
  });
  ...
  describe('LeakagePower', function() {
    it('should create an instance of LeakagePower', function() {
      // uncomment below and update the code to test LeakagePower
      //var instane = new PowermeterApi.LeakagePower();
      //expect(instance).to.be.a(PowermeterApi.LeakagePower);
    });
