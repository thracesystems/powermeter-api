...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.TechnologyVersion();
  });
  ...
  describe('TechnologyVersion', function() {
    it('should create an instance of TechnologyVersion', function() {
      // uncomment below and update the code to test TechnologyVersion
      //var instane = new PowermeterApi.TechnologyVersion();
      //expect(instance).to.be.a(PowermeterApi.TechnologyVersion);
    });
