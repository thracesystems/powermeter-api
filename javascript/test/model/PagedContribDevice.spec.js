...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PowermeterApi.PagedContribDevice();
  });
  ...
  describe('PagedContribDevice', function() {
    it('should create an instance of PagedContribDevice', function() {
      // uncomment below and update the code to test PagedContribDevice
      //var instane = new PowermeterApi.PagedContribDevice();
      //expect(instance).to.be.a(PowermeterApi.PagedContribDevice);
    });
